...
async fn test_bart_encoder_step_by_step_parity() -> Result<()> {
    ...
    // let cpu_encoder = cpu_model.cpu_encoder()?;
    // let gpu_encoder = gpu_model.gpu_encoder()?;
    ...
    // Add this check right after the layer-by-layer tests:
