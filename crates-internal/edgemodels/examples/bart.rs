...
async fn main() -> Result<()> {
    ...
    let cpu_dec_embed = cpu_decoder.debug_embeddings(&decoder_input_cpu, position_offset);
    ...
    let cpu_dec_ln = cpu_decoder.debug_embed_with_ln(&decoder_input_cpu, position_offset);
