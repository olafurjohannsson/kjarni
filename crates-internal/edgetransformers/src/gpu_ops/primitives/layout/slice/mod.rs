...
use crate::gpu_ops::{GpuTensor, DType};
use std::sync::Arc;
...
struct SliceUniforms {
    src_stride_b: u32, src_stride_h: u32, src_stride_s: u32, src_stride_d: u32,
    dst_stride_b: u32, dst_stride_h: u32, dst_stride_s: u32, dst_stride_d: u32,
    offset_b: u32, offset_h: u32, offset_s: u32, offset_d: u32,
    dst_shape_b: u32, dst_shape_h: u32, dst_shape_s: u32, dst_shape_d: u32,
}


impl GpuSlice {
    pub fn new(context: &Arc<WgpuContext>) -> Self {
        let shader = context.device.create_shader_module(wgpu::include_wgsl!("slice.wgsl"));
    ...
    pub fn encode(
        ...
        let uniforms = SliceUniforms {
            ...
            offset_b: offset[0] as u32, offset_h: offset[1] as u32, offset_s: offset[2] as u32, offset_d: offset[3] as u32,
            dst_shape_b: dst_b as u32, dst_shape_h: dst_h as u32, dst_shape_s: dst_s as u32, dst_shape_d: dst_d as u32,
        };
        ...
        let mut compute_pass = encoder.begin_compute_pass(&wgpu::ComputePassDescriptor { label: Some("Slice Pass"), timestamp_writes: None });
