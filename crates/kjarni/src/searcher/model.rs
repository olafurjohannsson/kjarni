...
use kjarni_rag::{IndexReader, SearchMode, SearchResult};
...
impl Searcher {
    ...
    pub async fn search(&self, index_path: &str, query: &str) -> SearcherResult<Vec<SearchResult>> {
        self.search_with_options(index_path, query, &SearchOptions::default())
            .await
    }
