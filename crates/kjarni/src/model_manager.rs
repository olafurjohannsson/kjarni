...
pub(crate) struct ModelManager {
    ...
    pub seq2seq_generator: Mutex<Option<EncoderDecoderGenerator>>,
}
...
impl ModelManager {
    ...
    pub async fn unload_text_generator(&self) {
        // *self.text_generator.lock().await = None;
        unimplemented!()
    }
    pub async fn unload_seq2seq_generator(&self) {
        *self.seq2seq_generator.lock().await = None;
    }
