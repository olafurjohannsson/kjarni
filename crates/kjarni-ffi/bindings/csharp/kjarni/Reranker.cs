...
namespace Kjarni
{
    ...
    public class Reranker : IDisposable
    {
            ...
            bool quiet = false)
        {
            ...
            config.Device = device == "gpu" ? Native.KjarniDevice.Gpu : Native.KjarniDevice.Cpu;
        ...
        public RerankResult[] Rerank(string query, string[] documents)
        {
            ...
            var err = Native.kjarni_reranker_rerank(
                _handle, query, documents, (UIntPtr)documents.Length, out var results);
            Native.CheckError(err);
        ...
        public RerankResult[] RerankTopK(string query, string[] documents, int k)
        {
            ...
            var err = Native.kjarni_reranker_rerank_top_k(
                _handle, query, documents, (UIntPtr)documents.Length, (UIntPtr)k, out var results);
            Native.CheckError(err);
