...
use crate::encoder::CpuTransformerEncoder;
...
pub struct CpuTransformerEncoderDecoder {
    pub encoder: CpuTransformerEncoder,
...
impl CpuTransformerEncoderDecoder {
    pub fn new(
        ...
        let encoder = CpuTransformerEncoder::new(weights, encoder_config_adapter)?;
    ...
    pub fn encoder(&self) -> &CpuTransformerEncoder {
        &self.encoder
    }
}
