...
//                     for is in 0..2 {
//                         // 2 iterations covering the whole block
//                         // qh_ptr index base
//                         let idx_base = is * 32;
...
//                         let ql_vec_1 =
//                             _mm256_loadu_si256(ql_ptr.add(idx_base + 64) as *const __m256i);
            ...
            for block in blocks {
                unsafe {
                    ...
                    for is in 0..2 {
                        ...
                        // --- Dot Product (Splitting into low/high 128 lanes) ---
                        let mut dot_stream = |q_i8: __m256i,
                                              s_a: __m256,
                                              s_b: __m256,
                                              a_off: usize,
...
mod q6_k_avx2_test {
    ...
    use half::f16;
    // Import the official scalar implementation
    ...
    fn ground_truth_matmul(a: &[f32], b_blocks: &[BlockQ6_K], k: usize) -> Vec<f32> {
        ...
        // Reusable buffer to avoid allocation in loop
        ...
        for i in 0..rows {
            ...
            for b in 0..blocks_per_row {
                ...
                // 1. Use shared scalar dequantization
