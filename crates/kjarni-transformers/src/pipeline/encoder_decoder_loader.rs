...
//     use super::*;
//     use crate::common::HFGenerationConfig;
//     use crate::cpu::encoder::{CpuEncoder, EncoderOutput};
//     use crate::encoder_decoder::traits::{CpuCrossDecoder, DecoderOutput};
...
//                 head_dim: Some(self.hidden_size / self.num_heads),
...
//         assert_eq!(meta.num_hidden_layers, 2);
...
//         // This test verifies generation_config.json is loaded
//         // The actual loading happens inside load_from_pretrained
...
//         let input = crate::ModelInput::TokensCpu(Array2::zeros((2, 10)).view().to_owned().view());
